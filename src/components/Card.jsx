...
const Card = ({ title, description, image, link, githubLink, demoLink, isExploreMore = false }) => {
  if (isExploreMore) {
    return (
      <div className="max-w-sm rounded-xl overflow-hidden shadow-lg transition-all duration-300 transform hover:scale-[1.02] m-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-900 border-2 border-dashed border-blue-200 dark:border-gray-700 hover:border-blue-400 dark:hover:border-cyan-500 hover:shadow-xl hover:shadow-blue-100 dark:hover:shadow-cyan-900/30 h-full flex flex-col">
        <div className="p-6 flex flex-col items-center justify-center h-full">
          ...
          <Link
            to="/projects"
            className="px-6 py-3 bg-blue-100 dark:bg-cyan-900/50 text-blue-700 dark:text-cyan-400 rounded-lg font-medium hover:bg-blue-200 dark:hover:bg-cyan-800/70 transition-colors duration-200 flex items-center"
          >
            View All Projects
  ...
  return (
    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg transition-all duration-300 transform hover:scale-[1.02] m-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-xl hover:shadow-blue-100 dark:hover:shadow-cyan-900/20 h-full flex flex-col">
